#!/bin/bash
#USAGE: create new sequence file following FASTA format
#./ setup_from_random_cpu.sh 
#(tleap) "Once MELD is activated..."
#source leaprc.protein.ff14SB
#set default PBradii mboni3
#mol = sequence { <3 letter code> }
